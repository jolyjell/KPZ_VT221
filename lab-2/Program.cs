...
abstract class Subscription
{
    ...
    public void GetDetails()
    {
        ...
        Console.WriteLine($"Мінімальний період підписки: {MinimumSubscriptionPeriod} month(s)");
...
class DomesticSubscription : Subscription
{
    ...
    public override List<string> Channels => new List<string> { "Channel1", "Channel2", "Channel3" };
...
class EducationalSubscription : Subscription
{
    ...
    public override int MinimumSubscriptionPeriod => 1;
    public override List<string> Channels => new List<string> { "Education1", "Education2", "Education3", "Channel1" };
...
class PremiumSubscription : Subscription
{
    ...
    public override int MinimumSubscriptionPeriod => 1;
    public override List<string> Channels => new List<string> { "Channel1", "Channel2", "Channel3", "Channel4", "Channel5" };
    public override List<string> Features => new List<string> { "висоа якість", "без реклами" };
}
